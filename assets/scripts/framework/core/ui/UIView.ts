...
export default class UIView extends EventComponent {
    ...
    protected createrTime:number = 0;
    /**
    ...
    public static getViewPath(): ViewPath {
        Log.e(`具体界面具体实现请求实现public static ViewPath`);
        return Macro.ViewPathNull;
    }
    ...
    public set className(value: string) {
        ...
        this.createrTime = Manager.utils.milliseconds;
    }
    ...
    onLoad() {
        ...
        super.onLoad();
        Log.d(this.className +".onLoad use time:",Manager.utils.milliseconds-this.createrTime);
        Log.d("UIView.onLoad___", this._className);
    }

    onFairyLoad() {
        Log.d("UIView.onFairyLoad___", this._className);
    }
    ...
    onDestroy() {
        ...
        super.onDestroy();
        Log.d("UIView.onDestroy___:", this._className);
    }

    dispose() {
        Log.d("UIView.dispose___:", this._className);
        this.onDispose();
    }
