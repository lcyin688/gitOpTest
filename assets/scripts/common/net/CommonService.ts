...
export class CommonService extends Service {
    ...
    protected ip = "192.168.1.8";
    protected port = 18001;
    protected protocol: Net.Type = "wss"
    ...
    public setIp(ip:string) {
        this.ip = ip;
        if(this.ip.indexOf("192.168") != -1){
            Manager.gd.isLocal = true;
            this.protocol =  "ws";
        }
    }
    ...
    */
    ...
    protected isHeartBeat(data: Message): boolean {
        //示例
        return data.cmd == String(ProtoDef.pb.C2SPing);
    }
