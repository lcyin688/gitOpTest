...
export class CommonBundleUpdateHandlerImpl implements UpdateHandlerDelegate {
    private static _instance: CommonBundleUpdateHandlerImpl = null!;
    public static Instance() { return this._instance || (this._instance = new CommonBundleUpdateHandlerImpl()); }
    ...
    onUpdateFailed(item: UpdateItem): void {
        ...
        //     }
        // });
        Log.d("onUpdateFailed",item.bundle,"200ms re try");
        setTimeout(() => {
