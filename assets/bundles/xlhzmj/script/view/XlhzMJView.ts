...
import { XlhzMJLogic } from "../logic/XlhzMJLogic";
...
import mjXLHZcplayers from "./mjXLHZcplayers";
...
import { GuaJiSubId, MahColor, MahHPGOPerate, MahHu, MahPlayerState, MahQiangGangState, MahTableStage, PlayerAttr } from "../../../../scripts/def/GameEnums";
...
@ccclass
export default class XlhzMJView extends GameView {
    ...
    public mjXLHZcplayersSC:mjXLHZcplayers = null;
    ...
    public rulexlhzSC:Rulexlhz = null;
    ...
    static logicType = XlhzMJLogic;

    public get logic(): XlhzMJLogic | null {
    ...
    onFairyLoad(): void {
        ...
        let item = fgui.UIPackage.getItemByURL("ui://h3x2989zmz9gld");
        Log.e("=========",item.name);
        let startTime:number = Manager.utils.milliseconds;

        Manager.gd.LocalPosition = "XlhzMJView";
        ...
        this.rulexlhzSC = new Rulexlhz ();
        this.rulexlhzSC.Init(this,"rule");
        ...
        this.mjXLHZcplayersSC = new mjXLHZcplayers();
        this.mjXLHZcplayersSC.Init(this,"mjPlayers");
        this.mjXLHZcplayersSC.setInit();
        ...
        this.mjXLHZcplayersSC.SetCMJPlayer(CommonMJConfig.Direction.Bottom ,this.mjcplayersSC.GetMJCMJPlayer(CommonMJConfig.Direction.Bottom))
        this.mjXLHZcplayersSC.SetCMJPlayer(CommonMJConfig.Direction.Right ,this.mjcplayersSC.GetMJCMJPlayer(CommonMJConfig.Direction.Right))
        this.mjXLHZcplayersSC.SetCMJPlayer(CommonMJConfig.Direction.Top ,this.mjcplayersSC.GetMJCMJPlayer(CommonMJConfig.Direction.Top))
        this.mjXLHZcplayersSC.SetCMJPlayer(CommonMJConfig.Direction.Left ,this.mjcplayersSC.GetMJCMJPlayer(CommonMJConfig.Direction.Left))
        Log.d("xlhz onFairyLoad ","use time :",Manager.utils.milliseconds-startTime);
        ...
        this.iniDate();
        Log.d("xlhz onFairyLoad iniDate","use time :",Manager.utils.milliseconds-startTime); 



        Manager.globalAudio.playMusic("audio/xlhz_bgm",Config.BUNDLE_XLHZ,true);
    }
    ...
    ClickWanFa() 
    {
        ...
        this.rulexlhzSC.SetActiveRule(true)
    ...
    iniDate()
    {
        ...
        CommonMJConfig.HaveColorArr=[MahColor.CL_Wan,MahColor.CL_Tong,MahColor.CL_Tiao]
    ...
    OnGangCard(dataAll: { data: pb.S2CMahPGResult; endFun: () => {}; },removeTable:number[]  ) 
    {
        ...
        else if (showtype == MahQiangGangState.QGS_HasQiangGang  ) //有玩家可以胡 可以抢杠
        {
            this.OnGangCardReal(direct,data,removeTable,data.pg.type);
            let timerItem=  window.setTimeout(()=>{
                dataAll.endFun();
        ...
        else if (showtype == MahQiangGangState.QGS_NoQiangGang  ) //客户玩家点了过 只飘分
        {
            this.OnGangCardShowScore(data)
            ...
            // {
                ...
                let timerItem=  window.setTimeout(()=>{
                    if ( hudirect == CommonMJConfig.Direction.Bottom ) 
                    {
                        ...
                        // Log.w(" OnHuCardDefinite  展示通用胡 maxHu  "  ,maxHu  ) 
                ...
                this.mjXLHZcplayersSC.OnHu( hudirect,data.hu[i] ,huori )
                let timerItem2=  window.setTimeout(()=>{
                    this.mjXLHZcplayersSC.SHowHuCardHuEff(hudirect )
                    this.mjHeadPlayersSC.SHowHuCountEff(hudirect, this.mjXLHZcplayersSC.GetHuCount(hudirect ) )
                } , 500);
    ...
    ShowCenterHu(hutypeConfig: { huPath: string;aniName: string; texture: string; sound: string[]; huwin: string; hulose: string; },hucurrent:number) 
    {
        ...
        // this.mjPanelSC.PlayCenterEff("mjsp_tsani_shuanglqd","ani")
    ...
    OnReconnectGameData()
    {
        ...
        // Log.d("xlhz onFairyLoad OnReconnectGameData 0","use time :",Manager.utils.milliseconds-startTime); 
        startTime = Manager.utils.milliseconds;
        ...
        // Log.d("xlhz onFairyLoad OnReconnectGameData 1","use time :",Manager.utils.milliseconds-startTime); 
        startTime = Manager.utils.milliseconds;
        ...
        // Log.d("xlhz onFairyLoad OnReconnectGameData 2","use time :",Manager.utils.milliseconds-startTime); 
        startTime = Manager.utils.milliseconds;

        //结算中 不去处理重连 比赛场不去处理
        // Log.d("xlhz onFairyLoad OnReconnectGameData 3","use time :",Manager.utils.milliseconds-startTime); 
        startTime = Manager.utils.milliseconds;

        this.rulexlhzSC.SetData()
        // Log.d("xlhz onFairyLoad OnReconnectGameData 4","use time :",Manager.utils.milliseconds-startTime); 
        startTime = Manager.utils.milliseconds;
        ...
        // Log.d("xlhz onFairyLoad OnReconnectGameData 5","use time :",Manager.utils.milliseconds-startTime); 
        startTime = Manager.utils.milliseconds;
        ...
        // Log.d("xlhz onFairyLoad OnReconnectGameData all","use time :",Manager.utils.milliseconds-startTime); 
    }
    ...
    StopCoroutineTweenAni()
    {
        ...
        this.mjXLHZcplayersSC.StopCoroutineTweenAni();
        this.roomPlayersBehaviourSC.StopCoroutineTweenAni();
        this.mjHeadPlayersSC.StopCoroutineTweenAni();

        if (this.m_TimerArr !=null ) 
        {
            // Log.w(" StopCoroutineTweenAni XlhzMJView  this.m_TimerArr.length ",this.m_TimerArr.length)
            //关掉所有的延迟函数
    ...
    InitMJ()
    {
        ...
        {
            CommonMJConfig.IsShowOutCardTip = false
        }

        //初始化牌墙
        let totalCount = 108 +CommonMJConfig.HZTotalCount+CommonMJConfig.extraHZCount
    ...
    SetReconnect(endFun:()=>{})
    {
        ...
        for (const [key, val] of Object.entries(CommonMJConfig.MJMemberInfo)) {
            ...
            let cilentPos = MJTool.PositionToDirection(serverPos)
            let v =CommonMJConfig.MJMemberInfo[key]
            this.mjXLHZcplayersSC.SetPlayerReconnect(cilentPos,v )
    ...
    OnResetCards()
    {
        ...
        this.mjXLHZcplayersSC.ResetPlayer();
        this.StopCoroutineTweenAni();
    }
