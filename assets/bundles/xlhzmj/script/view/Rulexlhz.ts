...
import { GameCat, MahHu } from "../../../../scripts/def/GameEnums";
...
export default class Rulexlhz extends FLevel2UI {
    ...
    SetData()
    {
        ...
        let str=   CommonMJConfig.MjRoomRule.hongZhongType+"血流红中";
        ...
        let url =  fgui.UIPackage.getItemURL("hall", "xlhzrulewenben"+index)
