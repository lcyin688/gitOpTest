...
import MjPlayerXLThreeTwo from "./MjPlayerXLThreeTwo";



export default class mjXLThreeTwocplayers extends FLevel2UI {

    // protected selfGc: fgui.GComponent = null;
    private gameName_text: fgui.GObject = null;


    m_tablePlayers:MjPlayerXLThreeTwo[]=[];
    ...
    public setInit() {
        ...
        for(let i = 0;i< 4;i++) 
        {
            ...
            let item = new MjPlayerXLThreeTwo(itemobj.asCom);
            item.setInit();
